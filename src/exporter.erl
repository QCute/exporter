...
-spec export(Module :: module(), Function :: atom()) -> {module, module()} | {error, term()}.
export(Module, Function) ->
    export(Module, Function, 0).

%% @dod export Module:Function/Arity
-spec export(Module :: module(), Function :: atom(), Arity :: arity()) -> {module, module()} | {error, term()}.
export(Module, Function, Arity) ->
    ...
    %% replace
    NewChunks = lists:keyreplace("ExpT", 1, lists:keyreplace("LocT", 1, Chunks, {"LocT", LocalChunk}), {"ExpT", ExportChunk}),
